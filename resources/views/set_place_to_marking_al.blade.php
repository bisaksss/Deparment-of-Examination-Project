...
<head>
    ...
    <title>Select Marking Place A/L</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-center">
                         ...
                         <h1 class="font-weight-normal"> Set Places To Marking A/L </h1>
                            ...
                            <br>
                                 ...
                                 <div class="card-header text-left font-weight-bold">Add Details</div>
                                    <div class="card-body">
                                            ...
                                            <form action="/set_marking_place_al" method="post">
                                            ...
                                            &nbsp;
                                            <a href="/show_marking_place_database_al"><button type="button" class="btn btn-secondary">Show Database</button></a>
