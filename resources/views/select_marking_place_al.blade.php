...
<div id="app">
    ...
    <div class="container">
        ...
        <h5>For Selected Distric</h5>
                ...
                <td>
                 @if($data->is_complete)
                 <a href="/mark_as_not_select_al/{{$data->id}}"><button class="btn btn-secondary">Selected</button></a>
                 
                @else
                 <a href="/mark_as_select_al/{{$data->id}}"><button class="btn btn-success">Not Selected</button></a>
