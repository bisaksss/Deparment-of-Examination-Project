...
<div class="container space">
    ...
    <table class="table table-dark">
                                    ...
                                    <td> {{$data->year}}</td>
                                    <td>
                                    <a href="/edit_marking_place_al/{{$data->id}}"><button type="button" class="btn btn-light">Edit</button></a>
                                    </td>
                                    <td>
                                    <a href="/delete_marking_place_al/{{$data->id}}"><button type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
